...
export default function Nutrition() {
  ...
  return (
    <section className="bg-bg-elevated py-28 lg:py-40">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="relative aspect-4/3 w-full overflow-hidden">
            ...
            />
            <div className="absolute inset-0 bg-linear-to-t from-bg-elevated/30 to-transparent" />
          </div>
          ...
          <div>
            ...
            <h2 className="text-4xl font-normal leading-tight md:text-5xl">
              Nutrition, made <em className="text-gold">tangible.</em>
            </h2>
            ...
            <div className="mt-12 space-y-8">
              {points.map((p, i) => (
                <div key={i} className="flex gap-5">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center border border-gold/20 text-sm text-gold">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div>
                    <h3 className="text-base font-medium text-text">{p.label}</h3>
                    <p className="mt-1 text-[15px] font-light leading-relaxed text-text-secondary">
                      {p.text}
                    </p>
                  </div>
                </div>
